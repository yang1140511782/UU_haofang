...
App({
    onLaunch: function () {
      ...
      if (this.globalData.appId == 'wx6b5fd6b9a5bc3044'){//生产环境
        ...
        // this.globalData.javaOnlineHost = 'http://172.16.140.102:8102';
        // http: //172.16.140.102:8102
        ...
        // this.globalData.onlineHost = 'uuweb.51vfang.cn';//灰度环境
    ...
    onShow:function(){
        ...
        //用户行为配置
        setTimeout(function(){
            behaviorTool.getBehaviorConfig();
        },500)
    },
    onHide:function(){
        //小程序切换到后台
        ...
        behaviorTool.logoutWxAppRecord();
    },
    ...
    globalData: {
        ...
        //检索楼盘信息
        getBuildListAction: '/Mini/App/getBuildListAction',
        //发布房源委托
        ...
        //客服智能回复
        smartService:'/Mini/Im/smartServiceNew',
        ...
        //房源委托书
        standingOrderUrl: '/Mini/Html/standingOrder',
        // 新盘楼书分享
        ...
        //专属客服快捷回复数据
        getCustomerConsultation:'/Mini/Im/getCustomerConsultation',

        //关注/收藏 页相关接口
        getAttentionList: '/Mini/App/getAttentionList', // 获取UU用户 关注的经纪人列表
        addOrRemoveAttention: '/Mini/App/addOrRemoveAttention', //添加关注经纪人
        isAttentionBroker: '/Mini/App/isAttentionBroker', //UU用户是否关注指定经纪人
        getHouseCollectionList: '/Mini/App/getHouseCollectionList', //获取UU用户房源收藏列表
        getHouseHistoryList: "/Mini/App/getHouseHistoryList", //获取UU用户浏览房源列表
